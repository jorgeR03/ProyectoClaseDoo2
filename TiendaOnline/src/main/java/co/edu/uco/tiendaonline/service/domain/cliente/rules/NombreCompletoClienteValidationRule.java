...
public final class NombreCompletoClienteValidationRule implements ValidatorRule<NombreCompletoClienteDomain>{
	
	private static final ValidatorRule<NombreCompletoClienteDomain> instancia = new NombreCompletoClienteValidationRule();
