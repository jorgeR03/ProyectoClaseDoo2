...
public final class NumeroIdentificacionClienteValidationRule implements ValidatorRule<String>{

	private static final ValidatorRule<String> instancia = new NumeroIdentificacionClienteValidationRule();
