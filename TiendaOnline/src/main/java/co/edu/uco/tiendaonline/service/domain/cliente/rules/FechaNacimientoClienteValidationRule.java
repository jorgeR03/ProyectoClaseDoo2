...
public final class FechaNacimientoClienteValidationRule implements ValidatorRule<Date> {
	
	private static final ValidatorRule<Date> instancia = new FechaNacimientoClienteValidationRule();
